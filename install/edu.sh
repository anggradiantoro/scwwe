...
yell='\e[1;33m'
NC='\e[0m'
curl -sS https://raw.githubusercontent.com/scvpn/perizinan/main/ascii-home | lolcat
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-nontls https://raw.githubusercontent.com/kamunikan/scwwe/main/ws/ws-nontls.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/kamunikan/scwwe/main/ws/ws-ovpn.py
